...
- [ ] Monetary logic impact identified. If touched, formulas stay in pure
      functions under `src/lib` or an explicit business-logic module.
- [ ] Monetary arithmetic uses `decimal.js` or shared decimal helpers; no raw
