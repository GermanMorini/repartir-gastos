...
### Constitution Alignment *(mandatory for technical features)*

- If the feature touches monetary behavior, specify the user-visible rule and
  require implementation through centralized pure calculation functions.
- If the feature touches money calculations, specify that arithmetic uses
