import { BedIcon, BottleWineIcon, CarIcon, CircleEllipsisIcon, FuelIcon, HeartPulseIcon, HomeIcon, PartyPopperIcon, PizzaIcon } from "lucide-react"
import type { CategoriaGasto } from "../types/index.ts"

export const CATEGORIAS_GASTO: { key: CategoriaGasto; label: string; color: string; icon: typeof PizzaIcon }[] = [
  { key: "comida", label: "Comida", color: "#86efac", icon: PizzaIcon },
  { key: "bebida", label: "Bebida", color: "#7dd3fc", icon: BottleWineIcon },
