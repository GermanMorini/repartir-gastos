...
function Select({
  ...
  return (
    <SelectOpenContext.Provider value={{ open: currentOpen, setOpen }}>
      <SelectPrimitive.Root data-slot="select" open={currentOpen} onOpenChange={setOpen} {...props} />
